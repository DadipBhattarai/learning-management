							...
							<div class="span12">
								<form action="read.php" method="post">
									<?php if (isset($not_read) && $not_read == '0') { ?>
										<!-- No button is displayed if $not_read is 0 -->
									<?php } else { ?>
									...
									if ($count > 0) {
										while ($row = mysqli_fetch_array($query)) {
											...
											if (mysqli_num_rows($query_yes_read) > 0) {
											...
											<div class="post" id="del<?php echo $id; ?>">
												<?php if ($yes === 'yes') { // Notification already read ?>
													<!-- No checkbox needed for already read notifications -->
												<?php } else { ?>

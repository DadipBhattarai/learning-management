...
if (isset($_POST['un']) && isset($_POST['fn']) && isset($_POST['ln']) && isset($_POST['class_id'])) {
    ...
    if (mysqli_num_rows($check_query) > 0) {
        ...
        // Insert new student
        $insert_query = mysqli_query($conn, "INSERT INTO student (username, firstname, lastname, location, class_id, status)
        VALUES ('$un', '$fn', '$ln', 'uploads/NO-IMAGE-AVAILABLE.jpg', '$class_id', 'Unregistered')") or die(mysqli_error($conn));

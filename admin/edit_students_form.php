    ...
    <div class="block-content collapse in">
      ...
      <div class="span12">
        <form method="post">
          ...
          <div class="control-group">
            <div class="controls">
              <select name="cys" class="" required>
                <!-- Display the current class for the student -->
                <option value="<?php echo htmlspecialchars($row['class_id']); ?>">
                  <?php echo htmlspecialchars($row['class_name']); ?>
                </option>

                <!-- Fetch and display all available classes -->
                <?php
                $cys_query = mysqli_query($conn, "SELECT * FROM class ORDER BY class_name") or die(mysqli_error($conn));
                while ($cys_row = mysqli_fetch_array($cys_query)) {
                  ?>
                  <option value="<?php echo htmlspecialchars($cys_row['class_id']); ?>">
                    <?php echo htmlspecialchars($cys_row['class_name']); ?>
                  </option>
                  <?php
                }
                ?>
          ...
          <div class="control-group">
            <div class="controls">
              <input name="un" value="<?php echo $row['username']; ?>" class="input focused" id="focusedInput"
          ...
          <div class="control-group">
            <div class="controls">
              <input name="fn" value="<?php echo $row['firstname']; ?>" class="input focused" id="focusedInput"
          ...
          <div class="control-group">
            <div class="controls">
              <input name="ln" value="<?php echo $row['lastname']; ?>" class="input focused" id="focusedInput"
